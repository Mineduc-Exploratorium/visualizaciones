...
/** @lends VistaPrincipal.prototype */
	...
	*/
	initialize: function() {
		...
		this.attrsize = "";				// Atributo en base al cual se calcula el radio de cada nodo (no)
 		this.attrcolor = "tipo_institucion_nivel_1";
  		this.attrTipoIE = this.attrcolor;	// Atributo en base al cual define color de los nodos
	...
	*/
	...
	// gatillada al recibir evento de vista this.vistaSelectorAreas
	// Parámetros:
	// - areaSeleccionada: string con area seleccionada
	...
	*/
	render: function() {
    	...
    	// -------------------------------------------------
    	// Crea un nuevo div para contener el panel
    	var elSelectorTipoIEs = d3.select(this.el).append("div").attr("id", "panelSelectorTipoIE")
		// Genera contenido del panel y escucha a evento con tipo seleccionado
		this.vistaSelectorTipoIE= new VistaPanelTipoIE({el:"#panelSelectorTipoIE", colorScale: this.colorScale});
		this.vistaSelectorTipoIE.on("seleccionTipoIE", this.seleccionTipoIE);
		...
		this.vistaSelectorAreas.on("seleccionArea", this.seleccionArea);


		// Elemento SVG (contenedor principal de gráfica)
		// ==============================================
